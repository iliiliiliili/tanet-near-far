...
CUDA_VISIBLE_DEVICES=3 python ./pytorch/train.py train --config_path=./configs/tanet/ped_cycle/xyres_28.proto --model_dir=/home/io3/TANet/pointpillars_with_TANet/ped_cycle_xyres_28_pure  --refine_weight 5
