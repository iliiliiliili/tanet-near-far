...
CUDA_VISIBLE_DEVICES=0 python ./pytorch/train.py evaluate --config_path=./configs/tanet/car/xyres_16.proto --model_dir=/home/io3/TANet/pointpillars_with_TANet/car_trained_model
