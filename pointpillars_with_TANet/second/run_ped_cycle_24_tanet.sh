...
CUDA_VISIBLE_DEVICES=2 python ./pytorch/train.py train --config_path=./configs/tanet/ped_cycle/xyres_24.proto --model_dir=/home/io3/TANet/pointpillars_with_TANet/ped_cycle_xyres_24_pure  --refine_weight 5
