...
CUDA_VISIBLE_DEVICES=1 python ./pytorch/train.py train --config_path=./configs/tanet/ped_cycle/xyres_20.proto --model_dir=/home/io3/TANet/pointpillars_with_TANet/ped_cycle_xyres_20_pure  --refine_weight 5
